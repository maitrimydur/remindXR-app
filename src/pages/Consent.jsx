...
export default function Consent() {
  ...
  return (
    <div className="container">
      <Header title="Consent" backTo="/" />
      <div className="content" style={{ paddingTop: '16px' }}>
        <p style={{ marginBottom: '12px', color: 'var(--color-text-dark)' }}>
        ...
        >
          <h3 style={{ marginBottom: '8px', color: 'var(--color-text-dark)', fontWeight: 600 }}>
            Purpose of Study
          </h3>
          <p style={{ marginBottom: '8px', color: 'var(--color-text-dark)' }}>
          ...
          <ul style={{ paddingLeft: '20px', marginBottom: '8px', color: 'var(--color-text-dark)' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', marginBottom: '24px' }}>
          ...
          />
          <label style={{ fontSize: '1rem', color: 'var(--color-text-dark)' }}>
        ...
        <button className="btn btn-large" onClick={handleAgree} disabled={!checked}>
          I Agree
        </button>
      </div>
    </div>
